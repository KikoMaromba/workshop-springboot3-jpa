...
@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner {//Use a o CommandLineRunner para rodar um código na inicialização
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T19:53:07Z"), o3);
